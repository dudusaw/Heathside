...
namespace Game.Control
{
    ...
    public class DashData : ScriptableObject
    {
        ...
        [SerializeField]
        public DashExplosionEffect explosion;
        [SerializeField]
        public PhysicsMaterial2D noFriction;
        [SerializeField]
        public float maxTimeBetweenPresses = 0.2f;
        [SerializeField]
        ...
        [SerializeField]
        public float yResolvingVelocity = 10f;
        [SerializeField]
        public float colliderEdge = 0.05f;
        [SerializeField]
        [Range(0, 1)]
        public float castPercent = 0.2f;
    }
}
